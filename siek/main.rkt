...
(provide/require "explicate-control-R1.rkt")
(provide/require "explicate-control-R2.rkt")
(provide/require "uncover-locals-R1.rkt")
(provide/require "select-instructions-R1.rkt")
(provide/require "assign-homes-R1.rkt")
(provide/require "patch-instructions-R1.rkt")
(provide/require "print-x86-R1.rkt")
(provide/require "uncover-live-R1.rkt")
(provide/require "build-interference-R1.rkt")
(provide/require "assign-colors-R1.rkt")
(provide/require "allocate-registers-R1.rkt")
